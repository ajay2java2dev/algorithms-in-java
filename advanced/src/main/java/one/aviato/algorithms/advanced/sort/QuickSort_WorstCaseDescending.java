...
public class QuickSort_BestCaseRandom {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Original Case - Pivot with Last Index: Testing 100 Random started. Input: ");
        displayValues(array100);
        long startTime = System.nanoTime();
        sort(array100, 0 , array100.length -1);
        long finishTime = System.nanoTime();
        System.out.println("Original Case - Pivot with Last Index: Testing 100 Random finished. Results: ");
        displayValues(array100);
        System.out.println("Original Case - Pivot with Last Index: 100 Records Time taken: " + (finishTime - startTime));
