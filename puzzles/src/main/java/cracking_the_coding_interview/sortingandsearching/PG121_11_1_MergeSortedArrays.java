...
import algorithms.util.DisplayElements;
import algorithms.util.GenerateArrays;
...
public class PG121_11_1_MergeSortedArrays {
    ...
    public static void main(String[] args) {
        int [] array1 = GenerateArrays.getArrayBySortOrder(10, (byte) 1, 100);
        int [] array2 = GenerateArrays.getArrayBySortOrder(10, (byte) 1, 100);
        DisplayElements.showIntElements(array1);
        DisplayElements.showIntElements(array2);
        int [] array3 = Arrays.copyOf(array1, array1.length + array2.length);

        merge(array3, array2, array1.length, array2.length);
        DisplayElements.showIntElements(array3);
    }
}
