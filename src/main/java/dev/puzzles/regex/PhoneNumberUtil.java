package dev.puzzles.regex;

public class PhoneNumberUtil {

    public static void main(String[] args) {
        System.out.println("Phone number 1234567890 validation result: "+validatePhoneNumber("1234567890"));
        System.out.println("Phone number 123-456-789011 validation result: "+validatePhoneNumber("123-456-789011"));
    ...
    private static boolean validatePhoneNumber(String phoneNo) {
        ...
        if (phoneNo.matches("\\d{10}")) return true;
            ...
            //validating phone number where area code is in braces ()
                ...
                || phoneNo.matches("\\(\\d{3}\\)\\d{3}-\\d{4}")) return true;
